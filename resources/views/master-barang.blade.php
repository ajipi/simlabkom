                        ...
                        <div
                            ...
                            <div class="flex-1 flex items-center space-x-2">
                                <h5>
                                    ...
                                    <span class="dark:text-white">65</span>
                                </h5>
                                <h5 class="text-gray-500 dark:text-gray-400 ml-1">1-10 (65)</h5>
                                ...
                                <div id="results-tooltip" role="tooltip"
                                    ...
                                    Manampilkan 1-10 dari 65 hasil
                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                <thead
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="p-4">SN</th>
                                        <th scope="col" class="p-4">Kondisi</th>
                                        <th scope="col" class="p-4">In Hand</th>
                                        <th scope="col" class="p-4">On Loan</th>
                                        <th scope="col" class="p-4">Rating</th>
                                        <th scope="col" class="p-4">Last Loan Date</th>
                                    </tr>
                                </thead>
                                <tbody>
