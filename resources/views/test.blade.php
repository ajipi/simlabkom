    ...
    <div class="antialiased">
        ...
        <aside
                        ...
                        <ul id="dropdown-data" class="hidden py-2 space-y-2">
                            ...
                            <li>
                                <a href="/data-kategori"
                                    class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100">Kategori</a>
                            </li>
                            <li>
                                <a href="/data-ruang"
                                    class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100">Ruang</a>
                            </li>
                            <li>
                                <a href="/data-users"
                                    class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100">Users</a>
                            </li>
                        </ul>
                    </li>
                    <li>
            ...
            <div class="hidden absolute bottom-0 left-0 justify-center p-4 w-full lg:flex bg-white z-20">
                ...
                <button type="button"
                    class="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Sign
                    out</button>
            </div>
        </aside>
